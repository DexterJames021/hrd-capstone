...
<head>
    ...
    <?php require_once "../assets/helper/imports.php"?>
...
<body>
    ...
    <div class="dashboard-main-wrapper">
        ...
        <div class="dashboard-header ">
            <nav class="navbar navbar-expand-lg bg-white fixed-top m-2 rounded ">
        ...
        <!-- left sidebar -->
        <!-- ============================================================== -->
        <div class="nav-left-sidebar sidebar-dark mx-2 my-4 rounded">
            <div class="menu-list">
                ...
                <div class="container-fluid dashboard-content ">
                    ...
                    <!-- <div class="ecommerce-widget"> -->
                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                <div class="card">
                                    <h5 class="card-header">Todo
                                    <button type="button" class="btn btn-primary float-right" data-toggle="modal" data-target="#myModal">Add Task</button>

                                    </h5>

                                    <div class="card-body p-0">
                                        <div class="table-responsive">
                                            <table class="display table table-striped" id="TaskTable">
